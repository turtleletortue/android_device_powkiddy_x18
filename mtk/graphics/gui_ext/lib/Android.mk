...
LOCAL_C_INCLUDES:= \
    ...
    $(TOP)/device/powkiddy/x18/mtk/graphics/gui_ext/inc \
    $(TOP)/device/powkiddy/x18/mtk/graphics/ui_ext/inc \
    $(TOP)/device/powkiddy/x18/mtk/graphics/gralloc_extra/include
